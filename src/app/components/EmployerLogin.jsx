  ...
  const sections = [
    {
      ...
      content:
        "Use advanced filters and assessments to find the right candidates faster.",
    },
    {
        ...
        <div className="flex flex-wrap items-center justify-between py-10 md:py-12 xl:py-16 gap-8">
          <div className="w-full lg:w-1/2 space-y-5 text-center lg:text-left">
            ...
            <p className="text-base text-gray-600">
              ...
              Whether you're looking for entry-level or experienced
              professionals, we provide the tools to find the perfect match for
              your business.
            </p>
        ...
        <div className="py-4 lg:py-8 space-y-7">
          ...
          <Marquee>
            <div className="flex items-center gap-x-10 text-3xl lg:text-5xl font-semibold">
              🚀 Find Your Dream Job | 🔍 Thousands of Job Listings | 💼 Hire
              Top Talent Fast | 📢 Apply Now & Get Hired | 🌟 Trusted by Leading
              Enterprises
            </div>
          </Marquee>
        </div>
          ...
          <div className="w-full lg:w-[55%] space-y-6">
            <div className="space-y-3">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-[#309689] font-semibold text-lg">
              ...
              <p className="text-gray-700">
                Our platform helps you connect with top candidates effortlessly,
                ensuring a smooth hiring process with AI-based recommendations.
              </p>
            </div>
              ...
              {[
                {
                  ...
                  content:
                    "We analyze job descriptions and recommend the most suitable candidates instantly.",
                },
                {
                  title: "Automated Screening",
                  content:
                    "Save time with smart filters that prioritize high-potential candidates.",
                },
                {
                  title: "Seamless Interview Scheduling",
                  content:
                    "Coordinate interviews with built-in calendar integration.",
                },
              ].map((section, index) => (
                <div
                  key={index}
        ...
        <div className="flex flex-col lg:flex-row-reverse items-center lg:items-stretch gap-6">
          <div className="w-full lg:w-[55%] space-y-6">
            <div className="space-y-3">
              ...
              <p className="text-gray-700">
                Our AI-driven platform helps you discover, evaluate, and hire
                the best candidates with ease, streamlining the entire
                recruitment process.
              </p>
            </div>
              ...
              {[
                {
                  ...
                  content:
                    "Instantly connect with the most qualified job seekers based on your hiring needs.",
                },
                {
                  title: "Automated Resume Screening",
                  content:
                    "Filter out the best resumes using AI-powered screening tools.",
                },
                {
                  title: "Integrated Interview Scheduling",
                  content:
                    "Simplify coordination with automated interview scheduling and calendar sync.",
                },
              ].map((section, index) => (
                <div
                  key={index}
        ...
        <div className="flex flex-col lg:flex-row items-center lg:items-stretch gap-6">
          <div className="w-full lg:w-[55%] space-y-6">
            <div className="space-y-3">
              ...
              <p className="text-gray-700">
                Manage job postings, track applications, and find the perfect
            ...
            <div className="mt-4 space-y-3">
              {[
                {
                  title: "Secure Employer Dashboard",
                  content:
                    "Access a dedicated dashboard to monitor job postings and applications.",
                },
                {
                  title: "AI-Based Candidate Matching",
                  content:
                    "Get the best candidate recommendations based on job descriptions.",
                },
                {
                  title: "Instant Communication Tools",
                  content:
                    "Message and schedule interviews directly from your dashboard.",
                },
              ].map((section, index) => (
                <div
                  key={index}
